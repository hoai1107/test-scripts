...
WebUI.setText(findTestObject('Page_Vite App/input_Login_form_email'), 'abc@123.com')
...
WebUI.verifyElementPresent(findTestObject('Page_Vite App/p_Wrong account or password'), 0)
